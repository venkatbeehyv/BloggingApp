...
$(document).ready(function()
{
	if(employee_id != 0){
		...
		$(".main_top").append('<div id="reg"> <a href="HomePage" style="color:Azure">Logout</a></div>');
		$(".main_top").append('<div class="myProfile"><a href="myProfile.jsp" style="color:Azure">My Account</a></div>');
